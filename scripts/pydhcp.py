...
""" Action options """
parser.add_option(
    "-L", "--listen", action="store_true", dest="listen", help="", default="False"
)
parser.add_option(
    "-E", "--emit", action="store_true", dest="emit", help="", default="False"
)
parser.add_option(
    "-R",
    "--readable-conversion",
...
def main():
    ...
    if ActionSum > 1:
        print(
            "Command line error : [-L -E -R -B] Only one of these actions can be taken."
        )
        sys.exit(0)
