...
class DhcpNetwork:
    ...
    def CreateSocket(self):
        try:
            ...
            sys.stderr.write(
                "pydhcplib3.DhcpNetwork socket creation error : " + str(msg)
            )
        ...
        try:
            ...
            sys.stderr.write(
                "pydhcplib3.DhcpNetwork socket error in setsockopt SO_BROADCAST : "
                + str(msg)
            )
        ...
        try:
            ...
            sys.stderr.write(
                "pydhcplib3.DhcpNetwork socket error in setsockopt SO_REUSEADDR : "
                + str(msg)
            )
    ...
    def BindToDevice(self):
        try:
            ...
            sys.stderr.write(
                "pydhcplib3.DhcpNetwork.BindToDevice error in setsockopt SO_BINDTODEVICE : "
                + str(msg)
            )
        ...
        try:
            ...
            sys.stderr.write("pydhcplib3.DhcpNetwork.BindToDevice error : " + str(msg))

    def BindToAddress(self):
        try:
            self.dhcp_socket.bind((self.listen_address, self.listen_port))
        except socket.error as msg:
            sys.stderr.write("pydhcplib3.DhcpNetwork.BindToAddress error : " + str(msg))
...
class DhcpClientOld(DhcpNetwork):
    def __init__(
        ...
        try:
            ...
            sys.stderr.write(
                "pydhcplib3.DhcpClient socket creation error : " + str(msg)
            )
        ...
        try:
            ...
            sys.stderr.write(
                "pydhcplib3.DhcpClient socket error in setsockopt SO_BROADCAST or SO_REUSEADDR : "
                + str(msg)
            )
    ...
    def BindToDevice(self):
        try:
            ...
            sys.stderr.write(
                "pydhcplib3.DhcpClient socket error in setsockopt SO_BINDTODEVICE : "
                + str(msg)
            )
        ...
        try:
            ...
            sys.stderr.write("pydhcplib3.DhcpClient bind error : " + str(msg))
...
class DhcpServerOld(DhcpNetwork):
    def __init__(
        ...
        try:
            ...
            sys.stderr.write(
                "pydhcplib3.DhcpServer socket creation error : " + str(msg)
            )
        ...
        try:
            ...
            sys.stderr.write(
                "pydhcplib3.DhcpServer socket error in setsockopt SO_BROADCAST : "
                + str(msg)
            )
        ...
        try:
            ...
            sys.stderr.write("pydhcplib3.DhcpServer bind error : " + str(msg))
